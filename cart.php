    ...
    <div class="w3-container">
        ...
        <?php
          ...
          if(isset($_SESSION['username'])) {
            ...
            echo '<a href="address2.php"><button class="w3-button w3-blue w3-round-large " style="float:right;">COD</button></a>';
            echo '<a href="card.php"><button class="w3-button w3-blue w3-round-large " style="float:right;">CARD PAYMENT</button></a>';
          }
