...
<!-- FORM -->
      ...
      <div class="w3-container">
           ...
           <form method="POST" action="insert2.php">
                 ...
                 <h1 style="font-family: googlesans,sans-serif;font-size:23px;";>Input New Address</h1>

                 <input class = "w3-input" style="width:30%" type="text" placeholder="Address" name="address2" value="" required tabindex="1">
                 <br>
                 <input class = "w3-input" style="width:30%" type="text" placeholder="city" name="city2" value="" required tabindex="2">
                 <br>
                 <input class = "w3-input" style="width:30%" type="text" placeholder="Pin code" name="pin2" value="" required tabindex="3">
                 <br>

                 <br>

                 <input type="Submit" class="w3-btn w3-round" name="Submit" href="success.php" value="CONFIRM ORDER" style="background: #0078A0;  color: #fff; font-family:googlesans; font-size: 1em; padding: 10px;">
