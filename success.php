...
<body>
  ...
  <div class="w3-center">
    ...
    <p style="font-family:googlesans;font-size:25px;">Success,&nbsp;<?php echo '<p style="font-family:googlesans;font-size:25px;">Hi ' .$_SESSION['fname'] .', task Executed successfully.</p>'; ?></p>
