...
<div class="w3-container">
     ...
     <form method="POST" action="insert2.php">
           ...
           <h1 style="font-family: googlesans,sans-serif;font-size:23px;";>CARD PAYMENT</h1>

           <input class = "w3-input" style="width:30%" type="text" placeholder="CARD-NUMBER" name="cardno" value="" required tabindex="1">
           <br>
           <input class = "w3-input" style="width:30%" type="text" placeholder="CARD EXPIRY" name="cardexp" value="" required tabindex="2">
           <br>
           <input class = "w3-input" style="width:30%" type="text" placeholder="BANK NAME" name="bankname" value="" required tabindex="3">
           <br>
           <input class = "w3-input" style="width:30%" type="text" placeholder="CVV" name="cvv" value="" required tabindex="4">
           <br>

           <input type="submit" class="w3-btn w3-round" name="submit" value="Confirm order" style="background: #0078A0;  color: #fff; font-family:googlesans; font-size: 1em; padding: 10px;">
           <input type="button" class="w3-btn w3-round" name="" onclick="location.href='cart.php';"value="Back to cart" style="background: #0078A0;  color: #fff; font-family:googlesans; font-size: 1em; padding: 10px;">
