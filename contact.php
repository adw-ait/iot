...
<body>
  ...
  <div class="w3-bar w3-light-grey">
    ...
    <div class="w3-container ">
      <header>
        <h2 style="font-family:googlesans">About Us</h2>
      </header>
          <p style="font-family:googlesans; font-size:18px;">Get in touch with us</p>
          <p style="font-family:googlesans; font-size:18px;">E-mail us at : <a style="text-decoration:none;"href="mailto:iot_products@gmail.com">iot_products@gmail.com</a></p>
    </div>
